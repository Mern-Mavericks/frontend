...
async function main() {
  const uri = 'mongodb+srv://mernproject:mernproject@mernproject.c1gssia.mongodb.net/mernproject?retryWrites=true&w=majority';
  ...
  try {
    ...
    const products = [
      ...
      },
      {
        ...
        description: "Brews coffee with precision and includes a built-in grinder.",
        price: 129.99,
        category: "Appliances",
        featured: true,
      ...
      },
      {
        ...
        description: "Adjustable stand for smartphones and tablets, ideal for video calls.",
        price: 19.99,
      ...
      },
      {
        ...
        name: "Yoga Mat",
        description: "Eco-friendly, non-slip yoga mat perfect for all types of yoga.",
        price: 25.99,
        category: "Fitness",
        featured: true,
      ...
      },
      {
        ...
        description: "High-quality electric guitar for beginners and professionals.",
        price: 349.99,
